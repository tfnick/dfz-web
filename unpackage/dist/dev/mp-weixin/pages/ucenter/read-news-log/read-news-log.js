...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return {
        a: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            b: "acb74d6a-3-" + i0 + "-" + i1 + "," + ("acb74d6a-2-" + i0 + "-" + i1),
            c: common_vendor.p({
            ...
            d: index,
            e: common_vendor.o(($event) => $options.handleItemClick(item)),
            f: "acb74d6a-2-" + i0 + "-" + i1 + "," + ("acb74d6a-1-" + i0)
          };
        }),
        b: "acb74d6a-1-" + i0 + ",acb74d6a-0",
        c: "acb74d6a-4-" + i0 + ",acb74d6a-0",
        d: common_vendor.p({
          state: {
            data,
            pagination,
    ...
    d: common_vendor.sr("udb", "acb74d6a-0"),
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/mac/Projects/WEB/dfz-web/dfz-web/pages/ucenter/read-news-log/read-news-log.vue"]]);
