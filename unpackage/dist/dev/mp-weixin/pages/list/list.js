...
const gps = new uni_modules_jsonGps_js_sdk_gps.Gps(), db = common_vendor.St.database();
const _sfc_main = {
  components: {
    statusBar
  },
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return {
      ...
      return {
        a: common_vendor.f(data, (item, index, i1) => {
          return {
            ...
            d: "2e5f5418-5-" + i0 + "-" + i1 + "," + ("2e5f5418-4-" + i0 + "-" + i1),
            e: common_vendor.p({
            ...
            f: index,
            g: "2e5f5418-4-" + i0 + "-" + i1 + "," + ("2e5f5418-3-" + i0),
            h: common_vendor.p({
              to: "/pages/list/detail?id=" + item._id + "&title=" + item.title
            })
          };
        }),
        b: "2e5f5418-6-" + i0 + "," + ("2e5f5418-3-" + i0),
        c: common_vendor.p({
          state: {
            data,
            pagination,
    ...
    j: common_vendor.sr("udb", "2e5f5418-2"),
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-2e5f5418"], ["__file", "/Users/mac/Projects/WEB/dfz-web/dfz-web/pages/list/list.nvue"]]);
