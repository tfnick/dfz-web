...
const _sfc_main = {
  ...
  created() {
    this.db = common_vendor.St.database();
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    a: common_vendor.sr("searchBar", "d9cb46f2-0"),
    ...
    m: common_vendor.f($data.localSearchList, (word, index, i0) => {
      return common_vendor.e({
        ...
        e: index,
        f: common_vendor.o(($event) => $options.LocalSearchlistItemClick(word, index))
      });
    }),
      ...
      return common_vendor.e({
        ...
        e: common_vendor.f(data, (word, index, i1) => {
          return {
            ...
            b: index,
            c: common_vendor.o(($event) => $options.search(word.content))
          };
        })
      }) : {}), {
        f: i0,
    ...
    v: common_vendor.sr("udb", "d9cb46f2-5"),
    w: common_vendor.p({
      field: "content",
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__scopeId", "data-v-d9cb46f2"], ["__file", "/Users/mac/Projects/WEB/dfz-web/dfz-web/pages/list/search/search.nvue"]]);
