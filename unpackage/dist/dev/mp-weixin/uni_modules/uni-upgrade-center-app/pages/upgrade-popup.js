...
const _sfc_main = {
  ...
  methods: {
    ...
    async saveFile(tempFilePath, version) {
      const [err, res] = await common_vendor.index.saveFile({
        tempFilePath
      });
      if (err) {
        return;
...
function _sfc_render(_ctx, _cache, $props, $setup, $data, $options) {
  return common_vendor.e({
    ...
    o: common_vendor.o((...args) => $options.downloadPackage && $options.downloadPackage(...args))
...
var MiniProgramPage = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/mac/Projects/WEB/dfz-web/dfz-web/uni_modules/uni-upgrade-center-app/pages/upgrade-popup.vue"]]);
