...
var uni_modules_uniSignIn_utils_ad = require("../../utils/ad.js");
var _imports_0 = "/uni_modules/uni-sign-in/static/background.png";
  ...
  return {
    ...
    d: common_vendor.f($data.weekdays, (item, index, i0) => {
      return common_vendor.e({
        ...
        e: "2d9a3fbe-2-" + i0 + ",2d9a3fbe-0",
        f: common_vendor.p({
          color: "#FFFFFF",
          type: "closeempty"
        })
      } : {
        g: "2d9a3fbe-3-" + i0 + ",2d9a3fbe-0",
        h: common_vendor.p({
          type: "checkmarkempty",
          color: "#FFFFFF"
        })
    ...
    g: common_vendor.sr("popup", "2d9a3fbe-0"),
    h: common_vendor.p({
      type: "center"
    })
  };
}
var Component = /* @__PURE__ */ common_vendor._export_sfc(_sfc_main, [["render", _sfc_render], ["__file", "/Users/mac/Projects/WEB/dfz-web/dfz-web/uni_modules/uni-sign-in/components/uni-sign-in/uni-sign-in.vue"]]);
