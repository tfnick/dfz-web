...
\u8BE6\u7EC6\u4FE1\u606F\uFF1A${s4}`), r3(o4);
  ...
  // ../../../../../../Users/mac/Projects/WEB/dfz-web/dfz-web/unpackage/dist/dev/.nvue/pages/list/list.js
  ...
  function _sfc_render$32(_ctx, _cache, $props, $setup, $data, $options) {
    return (0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("u-text", null, (0, import_vue2.toDisplayString)($options.dateShow), 1);
  }
  var __easycom_02 = /* @__PURE__ */ _export_sfc(_sfc_main$32, [["render", _sfc_render$32], ["__file", "/Users/mac/Projects/WEB/dfz-web/dfz-web/uni_modules/uni-dateformat/components/uni-dateformat/uni-dateformat.vue"]]);
    ...
    return (0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
      ...
      $props.state.error ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", { key: 0 }, [
        $data.networkType == "none" ? ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("view", {
          ...
          (0, import_vue2.createElementVNode)("u-text", { class: "tip-text" }, (0, import_vue2.toDisplayString)($options.noNetwork), 1),
          (0, import_vue2.createElementVNode)("view", {
            class: "btn btn-default",
            onClick: _cache[0] || (_cache[0] = (...args) => $options.openSettings && $options.openSettings(...args))
          }, [
            (0, import_vue2.createElementVNode)("u-text", { class: "btn-text" }, (0, import_vue2.toDisplayString)($options.toSet), 1)
          ])
        ])) : ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("u-text", {
          key: 1,
          class: "error"
        }, (0, import_vue2.toDisplayString)($options.error) + "\uFF1A" + (0, import_vue2.toDisplayString)(JSON.stringify($props.state.error)), 1))
      ])) : ((0, import_vue2.openBlock)(), (0, import_vue2.createElementBlock)("u-text", {
        key: 1,
        class: "state-text"
      }, (0, import_vue2.toDisplayString)($props.state.loading ? "\u52A0\u8F7D\u4E2D..." : $props.state.hasMore ? "\u4E0A\u62C9\u52A0\u8F7D\u66F4\u591A" : "\u6CA1\u6709\u66F4\u591A\u6570\u636E\u4E86"), 1))
    ], 32);
  }
  var __easycom_22 = /* @__PURE__ */ _export_sfc(_sfc_main$22, [["render", _sfc_render$22], ["styles", [_style_0$22]], ["__file", "/Users/mac/Projects/WEB/dfz-web/dfz-web/components/uni-load-state/uni-load-state.vue"]]);
  ...
  var statusBar = /* @__PURE__ */ _export_sfc(_sfc_main$12, [["render", _sfc_render$12], ["styles", [_style_0$12]], ["__file", "/Users/mac/Projects/WEB/dfz-web/dfz-web/uni_modules/uni-nav-bar/components/uni-nav-bar/uni-status-bar.vue"]]);
  var isIos;
  ...
  var Gps = class {
    ...
    getLocation() {
      return __async(this, arguments, function* (param = {
        ...
        return new Promise((callback2) => __async(this, null, function* () {
          ...
          this.lock = true;
          uni.getLocation(__spreadProps2(__spreadValues2({}, param), {
            success: (res) => {
              this.lock = false;
              callback2(res);
            },
    ...
    checkAppGps() {
      return __async(this, null, function* () {
        ...
        if (uni.getSystemInfoSync().platform != "ios" && (yield permision.requestAndroidPermission("android.permission.ACCESS_FINE_LOCATION")) != 1) {
          return false;
        }
        return true;
      });
  ...
  var _sfc_main2 = {
    ...
    onShow() {
      return __async(this, null, function* () {
        ...
        formatAppLog("log", "at pages/list/list.nvue:129", location2);
      });
    },
    methods: {
      searchClick(e) {
  ...
  function _sfc_render2(_ctx, _cache, $props, $setup, $data, $options) {
    ...
    const _component_uni_dateformat = resolveEasycom((0, import_vue2.resolveDynamicComponent)("uni-dateformat"), __easycom_02);
    const _component_uni_list_item = resolveEasycom((0, import_vue2.resolveDynamicComponent)("uni-list-item"), __easycom_3);
    const _component_uni_load_state = resolveEasycom((0, import_vue2.resolveDynamicComponent)("uni-load-state"), __easycom_22);
      ...
      (0, import_vue2.createElementVNode)("view", { class: "pages" }, [
        ...
        (0, import_vue2.createVNode)(_component_unicloud_db, {
          ...
          default: (0, import_vue2.withCtx)(({ data, pagination, hasMore, loading, error: error2, options }) => [
            (0, import_vue2.createCommentVNode)(' \u57FA\u4E8E uni-list \u7684\u9875\u9762\u5E03\u5C40 field="user_id.username"'),
            (0, import_vue2.createVNode)(_component_uni_list, {
              ...
              default: (0, import_vue2.withCtx)(() => [
                ...
                ((0, import_vue2.openBlock)(true), (0, import_vue2.createElementBlock)(import_vue2.Fragment, null, (0, import_vue2.renderList)(data, (item, index) => {
                    ...
                    body: (0, import_vue2.withCtx)(() => [
                      (0, import_vue2.createElementVNode)("view", { class: "main" }, [
                        ...
                        (0, import_vue2.createElementVNode)("view", { class: "info" }, [
                          (0, import_vue2.createElementVNode)("u-text", { class: "author" }, (0, import_vue2.toDisplayString)(item.user_id[0] ? item.user_id[0].username : ""), 1),
                ...
                (0, import_vue2.createVNode)(_component_uni_list_item, null, {
                  body: (0, import_vue2.withCtx)(() => [
  ...
  var list = /* @__PURE__ */ _export_sfc(_sfc_main2, [["render", _sfc_render2], ["styles", [_style_02]], ["__file", "/Users/mac/Projects/WEB/dfz-web/dfz-web/pages/list/list.nvue"]]);
